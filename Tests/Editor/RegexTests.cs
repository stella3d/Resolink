...
namespace Resolink.Tests
{
    ...
    {
        [TestCase("/composition/layers/*/autopilot", "/composition/layers/[a-zA-Z0-9]+/autopilot$")]
        [TestCase("/composition/layers/*/clips/*/select", "/composition/layers/[a-zA-Z0-9]+/clips/[a-zA-Z0-9]+/select$")]
